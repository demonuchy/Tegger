...
from app.services.user.views import user_router, private_user_router
from app.services.application.views import application_router, admin_application_router
