...
### COMMIT Bereg Dona v1.5

**✨ Основные улучшения:**

- **📝 Система заявок** - Полный цикл подачи и обработки заявок на вступление теперь не только в боте но и в приложении
- **🎨 UI** - полностью переработан интерфейс добавлены функции просмотра подробной информации заявок прием/отклонение жестами 
навигация в приложении также с помощью жестов 
...
- ** Сервисы** - Полное разделение логики на сервисы 
- ** Версионирование** - Поддержка устаревших таблици ендпоинтов позволяет гибко и безшовно обновлять интерфейс
- ** Редактирование личного кабинета** - Добавлено редактирование личного кабинета добавление удаление и обновление личных данных
- ** Новыйе анимации** - Новые анимации ошибок и редактирования карточек 
